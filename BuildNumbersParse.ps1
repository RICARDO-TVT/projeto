# 3 script : Popula a tabela [inventory].[MSSQLBuildNumbers] com as mais recente compilação disponível lançada pela Microsoft
...
Import-Module SQLPS
   ...
   $sql = "DELETE FROM [inventory].[MSSQLBuildNumbers]" 
        Write-Host $sql
        Invoke-sqlcmd -Query $sql -ServerInstance "NBTITMA143622" -Database "DBA"
